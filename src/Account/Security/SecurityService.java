...
//        securityAccount.setTotalPaid(new Money(securityAccount.getTotalPaid().getAmount() - sellingAmount, currencyDAO.read("USD")));
//        securityAccount.setUnrealized(new Money(securityAccount.getUnrealized().getAmount() - sellingAmount, currencyDAO.read("USD")));
        securityDAO.update(securityAccount);
